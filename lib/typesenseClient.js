...
export async function updateVideoDocument(document, updateData) {
  try {
    ...
    const updateDocument = {
      height: parseNumber(updateData.height, document.height),
      width: parseNumber(updateData.width, document.width),
      size: parseNumber(updateData.size, document.size),
      duration: parseNumber(updateData.duration, document.duration),
      modified: now,
      ...
      audience: parseArray(updateData.audience, document.audience), // Added audience
